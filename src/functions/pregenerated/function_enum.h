...
// ******************************************
  ...
  FN_ZORBA_DATETIME_PARSE_DATETIME_3,
  ...
  FN_FOLD_LEFT_3,
  FN_FOLD_RIGHT_3,
  ZORBA_STORE_STATIC_INTEGRITY_CONSTRAINTS_DDL_ACTIVATE_1,
  ZORBA_STORE_STATIC_INTEGRITY_CONSTRAINTS_DDL_DEACTIVATE_1,
  ZORBA_STORE_STATIC_INTEGRITY_CONSTRAINTS_DML_CHECK_INTEGRITY_CONSTRAINT_1,
  ...
  OP_ZORBA_JSON_BOX_1,
  FN_ZORBA_JSOUND_ANNOTATE_4,
  FN_ZORBA_JSOUND_VALIDATE_4,
  MATH_SQRT_1,
  MATH_EXP_1,
  MATH_EXP10_1,
  MATH_LOG_1,
  ...
  FN_ZORBA_XML_CANONICALIZE_IMPL_2,
  ...
  FN_ZORBA_SEQ_VALUE_INTERSECT_2,
  FN_ZORBA_SEQ_VALUE_UNION_2,
  FN_ZORBA_SEQ_VALUE_EXCEPT_2,
  OP_CONCATENATE_N,
  FN_INDEX_OF_2,
  FN_INDEX_OF_3,
  FN_EMPTY_1,
  ...
  FN_ANALYZE_STRING_2,
  FN_ANALYZE_STRING_3,
  FN_ZORBA_STRING_ANALYZE_STRING_2,
